...
class NotifyUserByWhatsapp implements EmailObserverInterface
{
    ...
    {
        $notify = $this->notifyUserByWhatsapp($email);
        if (!$notify) {
    ...
    private function notifyUserByWhatsapp(Email $email): bool
    {
